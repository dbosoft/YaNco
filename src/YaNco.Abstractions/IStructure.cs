...
namespace Dbosoft.YaNco
{
    public interface IStructure : IDataContainer
    {
        ...
        /// </summary>
        /// <returns></returns>
        Either<RfcError, RfcFieldInfo[]> GetFieldInfos();
        ...
        /// </summary>
        /// <returns></returns>
        Either<RfcError, IDictionary<string,AbapValue>> ToDictionary();
        ...
        /// <returns></returns>
        Either<RfcError, Unit> SetFromDictionary<T>(IDictionary<string, T> dictionary);
        ...
        /// </summary>
        Either<RfcError, Unit> SetFromString(string content);
    }
}