...
namespace Dbosoft {
	namespace YaNco {
		namespace Native {
			...
			public interface class IDataContainerHandle: Dbosoft::YaNco::IDataContainerHandle
			{
			...
			public ref class ConnectionHandle : HandleBase<RFC_CONNECTION_HANDLE>, Dbosoft::YaNco::IConnectionHandle
			{
			internal:
			...
			public ref class FunctionDescriptionHandle : HandleBase<RFC_FUNCTION_DESC_HANDLE>, Dbosoft::YaNco::IFunctionDescriptionHandle
			{
			internal:
			...
			public ref class TypeDescriptionHandle : HandleBase<RFC_TYPE_DESC_HANDLE>, Dbosoft::YaNco::ITypeDescriptionHandle
			{
			internal:
			...
			public ref class FunctionHandle : DataContainerBase<RFC_FUNCTION_HANDLE>, Dbosoft::YaNco::IFunctionHandle
			{
			internal:
			...
			public ref class StructureHandle : DataContainerBase<RFC_STRUCTURE_HANDLE>, Dbosoft::YaNco::IStructureHandle
			{
			internal:
			...
			public ref class TableHandle : DataContainerBase<RFC_TABLE_HANDLE>, Dbosoft::YaNco::ITableHandle
			{
			internal:
